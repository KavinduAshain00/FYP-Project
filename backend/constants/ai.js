 ...
 * Override via env: GITHUB_MODELS_MODEL, GITHUB_MODELS_FALLBACK_MODEL, GITHUB_MCQ_MODEL, GITHUB_GENERAL_MODEL
 */

/** Primary model: hints, tutor, summaries, code/error explanation */
const AI_MODEL = "openai/gpt-4.1";
/** Used when the requested model errors (rate limit, outage); override: GITHUB_MODELS_FALLBACK_MODEL */
const AI_FALLBACK_MODEL = "meta/Llama-4-Scout-17B-16E-Instruct";
