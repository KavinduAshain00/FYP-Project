  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={`font-bold truncate ${earned ? "text-blue-50" : "text-blue-400"}`}
        >
          {name}
        </p>
        <p
          className={`text-xs truncate ${earned ? "text-blue-200" : "text-blue-500"}`}
        >
          {description}
        </p>
        <span
...
export const QuestCard = ({
  ...
  const statusStyles = {
    ...
    completed: {
      extra: "shadow-md shadow-neon-green/15",
      bg: "bg-neon-green/10",
    },
